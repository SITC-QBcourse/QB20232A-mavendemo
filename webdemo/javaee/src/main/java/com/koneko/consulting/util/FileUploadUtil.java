...
public class FileUploadUtil {
	...
	public FileUploadUtil(HttpServletRequest request,String uploadFile, String tempFile,String encoding, long maxSize, long fileMaxSize) throws Exception {
	...
	private void fileUploadHandler() throws Exception {
		...
		if(uploadFlag = this.request.getContentType() != null && this.request.getContentType().startsWith("multipart/form-data")) {
	...
	public void saveUploadFile(String paramName, List<String> uploadFileNames) throws Exception{
		...
		for(int i = 0; i < fileNames.length; i++) {
			...
			File descFile = new File(this.request.getServletContext().getRealPath(this.uploadFile) + uploadFileNames.get(i));
